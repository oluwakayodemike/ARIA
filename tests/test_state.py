...
SAMPLE_COVERAGE = {
    "T1059": {"technique_id": "T1059", "technique_name": "Command Line",
              "tactics": ["execution"], "verdict": "COVERED",
              "total_rules": 5, "enabled_rules": 5, "enabled_percentage": 100.0},
    "T1078": {"technique_id": "T1078", "technique_name": "Valid Accounts",
              "tactics": ["initial-access"], "verdict": "PARTIAL",
              "total_rules": 2, "enabled_rules": 0, "enabled_percentage": 0.0},
    "T1566": {"technique_id": "T1566", "technique_name": "Phishing",
              "tactics": ["initial-access"], "verdict": "GAP",
              "total_rules": 0, "enabled_rules": 0, "enabled_percentage": 0.0},
}

SAMPLE_SCORE = {
    "score": 50.0, "covered": 1, "partial": 1, "gaps": 1, "total": 3
}
...
class TestARIAState(unittest.TestCase):
    ...
    def test_to_summary_reasoning_log_is_a_copy(self):
        ...
        self.assertEqual(state.reasoning_log[0]["message"], "original message",
